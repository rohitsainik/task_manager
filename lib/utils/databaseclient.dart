...
class DatabaseHelper {
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $tableName(id INTEGER PRIMARY KEY, $columnItemName TEXT, $columnDescription TEXT, $columnDueDate TEXT, $columnStatus TEXT, $columnTask TEXT, $columnDateCreated TEXT)");
